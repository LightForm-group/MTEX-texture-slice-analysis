...
%% Plot the texture variation and the FE results (without PHI)
...
% add a legend
legend({'Temperature ({\circC})','Strain','Strain Rate ({s^-^1})','Texture Index','0{\circ},0{\circ},0{\circ} Component (%)'}, 'Location', [0.75,0.45,0,0])
