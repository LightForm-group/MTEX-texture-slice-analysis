...
% path to files
pname = '/Users/mbcx9cd4/Documents/MATLAB/ebsd/slice analysis - Ti compression/';
...
data_path = strcat(mech_tester,data_path,sample_name,ctf_file)
...
hold on
plot(strip_index,tilted_ND_volume_fraction*100,'Color',[0,0,1],'lineWidth',2) % blue);
hold off
